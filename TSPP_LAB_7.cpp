...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	do {
		...
		cout << " | 6 - Зайти в банк и пополненить кредита." << endl;
		cout << " | 7 - Возле входа в банк - на солнышке лежит котик и заинтересовано смотрит на вас." << endl;
		...
		switch (action) {
			...
			case 7: {
						int fun = 0;
						cout << " |=============================================================================" << endl;
						cout << " | Вы можете погладить котика (1), а ещё можете дать ему сосиску (2)" << endl;
						cin >> fun;
						switch (fun) {
						case 1: {
									cout << " ... " << endl;
						...
						case 2:{
								   cout << " Котик лениво поднялся и подошел к сосиске. Настороженно понюхал, повилял хвостом. " << endl;
								   cout << " Обиженный взгляд котика ясно даёт понять, что он не ест бумагу.  " << endl;
								   break;
						}
						}
						cout << " |=============================================================================" << endl;
